...
class PatternManager:
    ...
    def get_patterns(
            self, pattern_type: str = "all") -> Dict[str, List[Dict[str, Any]]]:
    ...
    def _read_patterns(self, file_path: Path,
    ...
    def remove_pattern(self, pattern_type: str,
        ...
        try:
            ...
            return {
                "success": True,
                "message": "Pattern rimosso con successo"
            }
        except Exception as e:
            return {"success": False, "error": str(e)}

    def update_pattern(self, pattern_type: str, pattern_id: str,
                       pattern: str, description: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "pattern": patterns[[i for i, p in enumerate(patterns)if p['id'] == pattern_id][0]]
            }
        except Exception as e:
            return {"success": False, "error": str(e)}
